  ...
  try {
    ...
    switch (stuff[0]) {
      ...
      case "entities": // Entities
        ...
        for (let key in stuff[1]) {
          // the u32 we got is how many entities the server sent to us.
          ...
          for (let i2 = 0; i2 < stuff[1][key].barrels.length; i2++)
            buf.put_u8(stuff[1][key].barrels[i2]);
